...
/**
 * Strings for component 'forum', language 'vi', branch 'MOODLE_27_STABLE'
 *
 * @package   forum
...
$string['trackforum'] = 'Theo dõi các bài gửi chưa đọc';
$string['tracking'] = 'Theo dõi';
$string['trackingoff'] = 'Tắt';
$string['trackingon'] = 'Bật';
$string['trackingoptional'] = 'Tùy chọn';
$string['trackingtype'] = 'Theo dõi các bài gửi mới đối với diễn đàn này?';
